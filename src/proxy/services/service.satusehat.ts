...
export class ProxySatusehatService extends BaseProxyService {
  constructor(
    ...
    super(proxyService, envPrefix, baseUrl, targetUrl, req, res, new Logger(ProxySatusehatService.name))
  }
